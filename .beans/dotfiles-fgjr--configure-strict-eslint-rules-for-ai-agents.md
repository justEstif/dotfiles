...
updated_at: 2026-04-18T02:25:45Z
---
...
Moved ESLint package to `~/Documents/projects/eslint-config-agent-strict` and set up GitHub repository at `justEstif/eslint-config-agent-strict` with OIDC NPM publishing workflow.
