function __wtm_help --description "Print wtm help"
    ...
    echo "    status [worktree] [options]       Show Git, PR, review, and CI status"
    ...
    echo
    echo "STATUS OPTIONS"
    echo "    --base <branch>                   Base branch for comparison (auto-detected)"
    echo "    --local                           Skip fetch and GitHub checks"
    echo
