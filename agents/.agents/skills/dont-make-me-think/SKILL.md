...
description: Apply Steve Krug's usability principles to writing. Use when user asks to make writing clearer, more scannable, easier to read, or references "Don't Make Me Think." Also triggers for requests like "simplify this," "make this scannable," "cut the fluff," "help people skim this," or when editing docs, emails, proposals, or technical writing for busy readers.
---

# Don't Make Me Think (Writing Edition)

Apply Steve Krug's web usability principles to written communication. The core premise: every sentence that makes readers work is a failure. Readers scan, they don't read.
...
- [ ] Did I cut at least 30% of the words?
- [ ] Can someone skim the headers and understand the structure?
- [ ] Is every paragraph <4 sentences?
